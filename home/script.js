document.addEventListener('DOMContentLoaded', () => {
  ...
  const continueFilterButtons = [...document.querySelectorAll('#continueFilters .chip')];
  const favoritesFilterButtons = [...document.querySelectorAll('#favoritesFilters .chip')];
  const watchLaterFilterButtons = [...document.querySelectorAll('#watchLaterFilters .chip')];
